...
- **v1.6.96**: center-lock + head-up で回転が地図中心で行われる問題を修正。回転ピボット補正関数 calcRotationPivotCenter を utils.ts に追加。全 5 モードの center-lock ブランチに適用。MOVE+TW の center-lock に Tween 補間を追加
