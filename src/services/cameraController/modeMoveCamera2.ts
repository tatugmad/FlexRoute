...
/** Mode MOVE2: moveCamera のみ + heading-master 方式。即時なので v1 と結果同一。 */
export class ModeMoveCamera2 implements CameraMode {
